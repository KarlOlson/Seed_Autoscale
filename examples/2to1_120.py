...
Makers.makeTransitAs(base, 161, [58, 47], [(58, 47)], proxy[99])
Makers.makeTransitAs(base, 162, [45, 58], [(45, 58)], proxy[100])
Makers.makeTransitAs(base, 163, [47, 59], [(47, 59)], proxy[101])
Makers.makeTransitAs(base, 164, [46, 59], [(46, 59)], proxy[102])
Makers.makeTransitAs(base, 165, [51, 50], [(51, 50)], proxy[103])
Makers.makeTransitAs(base, 166, [48, 51], [(48, 51)], proxy[104])
Makers.makeTransitAs(base, 167, [48, 52], [(48, 52)], proxy[105])
Makers.makeTransitAs(base, 168, [49, 52], [(49, 52)], proxy[106])
Makers.makeTransitAs(base, 169, [38, 60], [(38, 60)], proxy[107])
Makers.makeTransitAs(base, 170, [40, 53], [(40, 53)], proxy[108])
Makers.makeTransitAs(base, 171, [53, 41], [(53, 41)], proxy[109])
Makers.makeTransitAs(base, 172, [41, 54], [(41, 54)], proxy[110])
Makers.makeTransitAs(base, 173, [54, 42], [(54, 42)], proxy[111])
Makers.makeTransitAs(base, 174, [42, 55], [(42, 55)], proxy[112])
Makers.makeTransitAs(base, 175, [55, 43], [(55, 43)], proxy[113])
Makers.makeTransitAs(base, 176, [43, 56], [(43, 56)], proxy[114])
Makers.makeTransitAs(base, 177, [56, 44], [(56, 44)], proxy[115])
Makers.makeTransitAs(base, 178, [44, 57], [(44, 57)], proxy[116])
Makers.makeTransitAs(base, 179, [57, 45], [(57, 45)], proxy[117])
Makers.makeTransitAs(base, 180, [34, 58], [(34, 58)], proxy[118])
Makers.makeTransitAs(base, 181, [39, 60], [(39, 60)], proxy[119])
...
#####################################################################
Makers.makeStubAs(emu, base, 190, 2, [None], proxy[120])
Makers.makeStubAs(emu, base, 191, 3, [None], proxy[121])
Makers.makeStubAs(emu, base, 192, 4, [None], proxy[122])
Makers.makeStubAs(emu, base, 193, 5, [None], proxy[123])
Makers.makeStubAs(emu, base, 194, 6, [None], proxy[124])
Makers.makeStubAs(emu, base, 195, 7, [None], proxy[125])
Makers.makeStubAs(emu, base, 196, 8, [None], proxy[126])
Makers.makeStubAs(emu, base, 197, 9, [None], proxy[127])
Makers.makeStubAs(emu, base, 198, 10, [None], proxy[128])
Makers.makeStubAs(emu, base, 199, 11, [None], proxy[129])
Makers.makeStubAs(emu, base, 200, 12, [None], proxy[130])
Makers.makeStubAs(emu, base, 201, 13, [None], proxy[131])
Makers.makeStubAs(emu, base, 202, 14, [None], proxy[132])
Makers.makeStubAs(emu, base, 203, 15, [None], proxy[133])
Makers.makeStubAs(emu, base, 204, 16, [None], proxy[134])
Makers.makeStubAs(emu, base, 205, 17, [None], proxy[135])
Makers.makeStubAs(emu, base, 206, 18, [None], proxy[136])
Makers.makeStubAs(emu, base, 207, 19, [None], proxy[137])
Makers.makeStubAs(emu, base, 208, 20, [None], proxy[138])
Makers.makeStubAs(emu, base, 209, 21, [None], proxy[139])
Makers.makeStubAs(emu, base, 210, 22, [None], proxy[140])
Makers.makeStubAs(emu, base, 211, 23, [None], proxy[141])
Makers.makeStubAs(emu, base, 212, 24, [None], proxy[142])
Makers.makeStubAs(emu, base, 213, 25, [None], proxy[143])
Makers.makeStubAs(emu, base, 214, 26, [None], proxy[144])
Makers.makeStubAs(emu, base, 215, 27, [None], proxy[145])
Makers.makeStubAs(emu, base, 216, 28, [None], proxy[146])
Makers.makeStubAs(emu, base, 217, 29, [None], proxy[147])
Makers.makeStubAs(emu, base, 218, 30, [None], proxy[148])
Makers.makeStubAs(emu, base, 219, 31, [None], proxy[149])
Makers.makeStubAs(emu, base, 220, 32, [None], proxy[150])
Makers.makeStubAs(emu, base, 221, 33, [None], proxy[151])
Makers.makeStubAs(emu, base, 222, 34, [None], proxy[152])
Makers.makeStubAs(emu, base, 223, 35, [None], proxy[153])
Makers.makeStubAs(emu, base, 224, 36, [None], proxy[154])
Makers.makeStubAs(emu, base, 225, 37, [None], proxy[155])
Makers.makeStubAs(emu, base, 226, 38, [None], proxy[156])
Makers.makeStubAs(emu, base, 227, 39, [None], proxy[157])
Makers.makeStubAs(emu, base, 228, 40, [None], proxy[158])
Makers.makeStubAs(emu, base, 229, 41, [None], proxy[159])
Makers.makeStubAs(emu, base, 230, 42, [None], proxy[160])
Makers.makeStubAs(emu, base, 231, 43, [None], proxy[161])
Makers.makeStubAs(emu, base, 232, 44, [None], proxy[162])
Makers.makeStubAs(emu, base, 233, 45, [None], proxy[163])
Makers.makeStubAs(emu, base, 234, 46, [None], proxy[164])
Makers.makeStubAs(emu, base, 235, 47, [None], proxy[165])
Makers.makeStubAs(emu, base, 236, 48, [None], proxy[166])
Makers.makeStubAs(emu, base, 237, 49, [None], proxy[167])
Makers.makeStubAs(emu, base, 238, 50, [None], proxy[168])
Makers.makeStubAs(emu, base, 239, 51, [None], proxy[169])
Makers.makeStubAs(emu, base, 240, 52, [None], proxy[170])
Makers.makeStubAs(emu, base, 241, 53, [None], proxy[171])
Makers.makeStubAs(emu, base, 242, 54, [None], proxy[172])
Makers.makeStubAs(emu, base, 243, 55, [None], proxy[173])
Makers.makeStubAs(emu, base, 244, 56, [None], proxy[174])
Makers.makeStubAs(emu, base, 245, 57, [None], proxy[175])
Makers.makeStubAs(emu, base, 246, 58, [None], proxy[176])
Makers.makeStubAs(emu, base, 247, 59, [None], proxy[177])
Makers.makeStubAs(emu, base, 248, 60, [None], proxy[178])
Makers.makeStubAs(emu, base, 249, 61, [None], proxy[179])
...
ebgp.addRsPeers(34, [222, 147, 153, 160, 180])
ebgp.addRsPeers(35, [223, 152, 154, 159])
ebgp.addRsPeers(36, [224, 118, 120, 121])
ebgp.addRsPeers(37, [225, 103, 105, 106])
ebgp.addRsPeers(38, [226, 110, 115, 116, 169])
ebgp.addRsPeers(39, [227, 111, 112, 114, 115])
ebgp.addRsPeers(40, [228, 87, 88, 113, 114, 170])
ebgp.addRsPeers(41, [229, 84, 85, 86, 88, 171, 172])
ebgp.addRsPeers(42, [230, 76, 78, 79, 85, 173, 174])
ebgp.addRsPeers(43, [231, 77, 78, 136, 137, 175, 176])
ebgp.addRsPeers(44, [232, 137, 138, 141, 142, 177, 178])
ebgp.addRsPeers(45, [233, 142, 143, 146, 162, 179])
ebgp.addRsPeers(46, [234, 155, 157, 158, 164])
ebgp.addRsPeers(47, [235, 158, 159, 160, 161, 163])
ebgp.addRsPeers(48, [236, 104, 105, 118, 119, 117, 167, 166])
ebgp.addRsPeers(49, [237, 116, 117, 107, 168])
ebgp.addRsPeers(50, [238, 119, 120, 156, 157, 165])
ebgp.addRsPeers(51, [239, 166, 165])
ebgp.addRsPeers(52, [240, 168, 167])
ebgp.addRsPeers(53, [241, 170, 171])
ebgp.addRsPeers(54, [242, 172, 173])
ebgp.addRsPeers(55, [243, 174, 175])
ebgp.addRsPeers(56, [244, 176, 177])
ebgp.addRsPeers(57, [245, 178, 179])
ebgp.addRsPeers(58, [246, 162, 161, 180])
ebgp.addRsPeers(59, [247, 163, 164])
ebgp.addRsPeers(60, [248, 169, 181])
ebgp.addRsPeers(61, [249, 62, 63, 64, 65, 66, 67])



####AVG IX Connection = 310/60 = 5.16 ASes, 4.15 without Stubs.
...
emu.render()
emu.compile(Docker(), './output_2to1_120', override=True)
